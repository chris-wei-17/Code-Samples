...
int main(int argc, char **argv) {
    ...
    // Only the headers and pointer to the sl::Mat are copied, not the data itself
   	...
   	// For images at t = 0
    Mat image_zed_L_g_t0(new_width, new_height, MAT_TYPE::U8_C1);
    cv::Mat image_ocv_L_g_t0 = slMat2cvMat(image_zed_L_g_t0);
    Mat image_zed_R_g_t0(new_width, new_height, MAT_TYPE::U8_C1);
    cv::Mat image_ocv_R_g_t0 = slMat2cvMat(image_zed_R_g_t0);
    Mat depth_image_zed(new_width, new_height, MAT_TYPE::U8_C4);
    cv::Mat depth_image_ocv = slMat2cvMat(depth_image_zed);
    
    // For subsequent images t = t+
    Mat image_zed_L_g_t1(new_width, new_height, MAT_TYPE::U8_C1);
    cv::Mat image_ocv_L_g_t1 = slMat2cvMat(image_zed_L_g_t1);
    Mat image_zed_R_g_t1(new_width, new_height, MAT_TYPE::U8_C1);
    cv::Mat image_ocv_R_g_t1 = slMat2cvMat(image_zed_R_g_t1);
    ...
    // ------------------------    
        ...
        zed.retrieveImage(image_zed_L_g_t0, VIEW::LEFT_GRAY, MEM::CPU, new_image_size);
        zed.retrieveImage(image_zed_R_g_t0, VIEW::RIGHT_GRAY, MEM::CPU, new_image_size);
	}
    ...
    while (key != 'q') {
        ...
        if (zed.grab(runtime_parameters) == ERROR_CODE::SUCCESS) {
            ...
            zed.retrieveImage(image_zed_L_g_t1, VIEW::LEFT_GRAY, MEM::CPU, new_image_size);
            zed.retrieveImage(image_zed_R_g_t1, VIEW::RIGHT_GRAY, MEM::CPU, new_image_size);
        	...
        	matchingFeatures( image_ocv_L_g_t0, image_ocv_R_g_t0,
                          	image_ocv_L_g_t1, image_ocv_R_g_t1, 
                          	currentVOFeatures,
                          	pointsLeft_t0, 
                          	pointsRight_t0, 
                          	pointsLeft_t1, 
            ...
            image_ocv_L_g_t0 = image_ocv_L_g_t1;
        	image_ocv_R_g_t0 = image_ocv_R_g_t1;
...
/*        cv::Mat points3D_t1, points4D_t1;
        ...
        displayTracking(image_ocv_L_g_t1, pointsLeft_t0, pointsLeft_t1);
...
/*        points4D = points4D_t0;
        ...
        cv::putText(image_ocv_L_g_t1, camera_fps, cv::Point(15,30) , 1, 2, cv::Scalar(0,0,125), 2);
