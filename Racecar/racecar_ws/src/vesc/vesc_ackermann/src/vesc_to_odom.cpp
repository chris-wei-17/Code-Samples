...
void VescToOdom::vescStateCallback(const vesc_msgs::VescStateStamped::ConstPtr& state)
{
  ...
  odom->pose.covariance[0]  = 0.001; ///< x .2
  odom->pose.covariance[7]  = 0.005; ///< y .2
  odom->pose.covariance[14] = 0.001;  // z estimate
  odom->pose.covariance[21] = 0.100;
  odom->pose.covariance[28] = 0.100;
  odom->pose.covariance[35] = 0.4; ///< yaw .4
