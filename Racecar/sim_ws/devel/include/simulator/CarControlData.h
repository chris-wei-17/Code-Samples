...
bool operator==(const ::simulator::CarControlData_<ContainerAllocator1> & lhs, const ::simulator::CarControlData_<ContainerAllocator2> & rhs)
{
  return lhs.cv_speed == rhs.cv_speed &&
    lhs.cv_turn_zero == rhs.cv_turn_zero &&
    lhs.cv_turn_speed == rhs.cv_turn_speed &&
    lhs.vp_speed == rhs.vp_speed &&
    lhs.vp_turn_zero == rhs.vp_turn_zero &&
    lhs.vp_turn_speed == rhs.vp_turn_speed &&
    lhs.vesc_speed == rhs.vesc_speed;
}
